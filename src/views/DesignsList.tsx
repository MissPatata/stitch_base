...
export function DesignsList() {
  ...
  const filteredAndSortedDesigns = useMemo(() => {
    ...
    return result
  }, [designs, searchQuery, filterGarmentType, filterLength, filterStatus, sortBy])
  ...
  return (
    <div style={{ padding: theme.spacing.xl }}>
      ...
      >
        ...
        <Button onClick={() => setView({ type: "design-edit" })}>+ {t.designs.newDesign}</Button>
      </div>
      ...
      >
        {filteredAndSortedDesigns.map((design) => {
          ...
          return (
            ...
            >
              {previewImage && <ImagePreview imagePath={previewImage.filePath} alt={design.name} />}
              ...
              <div style={{ padding: theme.spacing.lg }}>
                ...
                <div
                  style={{ fontSize: "0.875rem", color: theme.colors.textSecondary, marginBottom: theme.spacing.sm }}
                >
                ...
                {design.tags.length > 0 && (
                  <div
                    style={{ display: "flex", flexWrap: "wrap", gap: theme.spacing.xs, marginBottom: theme.spacing.md }}
                  >
                ...
                >
                  <Button size="sm" variant="secondary" onClick={() => setView({ type: "design-edit", id: design.id })}>
                    {t.common.edit}
                  </Button>
                  <Button size="sm" variant="danger" onClick={() => handleDelete(design.id)}>
                    {t.common.delete}
                  </Button>
                </div>
              </div>
